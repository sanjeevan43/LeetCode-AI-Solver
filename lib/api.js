const API_BASE_URLS = [
  'https://backend-pdo7nrzke-sanjeevans-projects-45db636c.vercel.app',
  'https://backend-dun-ten-29.vercel.app'
];
...
export const api = {
  ...
  async solveProblem(problem, selectedLanguages = ['python']) {
    console.log('Solving problem:', problem.substring(0, 100) + '...');
    ...
    // Fallback to mock if no API solutions
